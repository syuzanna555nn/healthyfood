...
export const Landing:React.FC = () => {
    return (<>
        ...
        <StyledMainWrapper>
            <StyledHero>
            <StyledHead><StyledPartHead>Your </StyledPartHead>Favourite Food
                <StyledPartHead> Delivered</StyledPartHead> Hot & Fresh</StyledHead>
            <StyledDescription>HEALTHY SWITCHER chefs do all the prep work, like peeling, chopping & marinating, so you can cook a fresh homemade dinner in just 15 minutes.</StyledDescription>
                <Button title={"Order Now"} />
                <StyledContacts><ContactsInfo /></StyledContacts>
            <PageSlider />
            </StyledHero>
            <StyledBlock>
